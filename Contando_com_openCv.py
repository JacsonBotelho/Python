...
retval, th = cv2.threshold(imagemOriginal, 200, 255, cv2.THRESH_BINARY)
#cv2.imshow("th", th)
...
cv2.line(imagemOriginal, xy1, xy2, (255, 0, 0), 3)

cv2.line(imagemOriginal, (xy1[0], posL - offset), (xy2[0], posL - offset), (255, 255, 0), 2)
...
for cnt in contours:
    ...
    if int(area) > 2:
        ...
        cv2.putText(imagemOriginal, str(i), (x + 5, y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)
        cv2.circle(imagemOriginal, centro, 4, (0, 0, 255), -1)
...
cv2.putText(imagemOriginal, "TOTAL: " + str(total), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)
...
cap = cv2.imread("D:/Users/campo/Documents/ALURA\ANALISE_E_CLASSIFICACAO_FACIAL/alura-analise-facial-aula_3/alura-analise-facial-aula_3/imagens/soja.jpg")
